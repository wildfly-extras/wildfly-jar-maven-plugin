 ...
 * @author jdenise
 */
public class ServerModeCustomDirName extends AbstractBootableJarMojoTestCase {

    public ServerModeCustomDirName() {
        super("test-servermode2-pom.xml", true, null);
    }
    ...
    public void testCustomFileName() throws Exception {
        ...
        assertNotNull(mojo);
        assertNotNull(mojo.server.getDirectoryName());
        mojo.execute();
